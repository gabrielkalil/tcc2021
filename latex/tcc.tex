...
%[1 review] Precisa aparecer o fato que a igreja nasce no movimento de discípulos de Jesus, e neste movimento se concretiza. Importantar aparecer que ela nasce em pequenos grupos, no movimento de discípulos, num aspecto de Kononia.

%[2] Talvez colocar um parágrafo a mais (expandir)
...
%[2 review] Não explorou Mateus 28, precisa explorar. Base para Igreja multiplicadora, etc. (ver comentários). A continuidade do estilo de vida que Jesus já tinha implementad

Pouco antes de ser elevado aos céus e, finalizando seu ministério como "filho do homem", Jesus outorga poder a seus discípulos e os comissiona para replicar seu modelo e continuar o que ele começou. O evangelista Mateus registra esse evento conhecido como a Grande Comissão: 
...
%3 etapas brandao 
%desdobra nas dimensões de evangelismo, agregação ao Corpo de Cristo dos convertidos, e o posterior aperfeiçoamento %desses discípulos. 
%discipulado
%movimento

%[2] Bom ler o material da igreja multiplicadora já, teologia da igreja multiplicadora. Já usar a linguagem. Quando trabalhar o Mateus 28, importante trabalhar que essa evangelização (grego como gerûndio, talvez argumentar o indo.). Fazem uma evangelização que é uma evangelização discipuladora (Título abaixo). Vai mexer com o texto, fechar com o final. Ver vídeo.. aprendizes precisam ser apresentados em Mat 28 junto com conceito de evangelizaç discipuladora. (método apresentado em Mat 28). Pode aparecer desde que tenha aparecido em Mat 28, base teórica para evangelismo discipulador.
...
%[2] Uma vez que trabalhou Mat 28, esses elementos nascem daí. Para fazer aprendizes de Jesus, preciso ser relacional (aparece lá). Aqui já fazer o gancho de Mat 28, trazer de onde vem a tese, Mat 28.
...
% posso gastar algumas linhas para colocar o estilo de vida deles, vai dar a base para os princípios de igreja multiplicadora. Didake (evangelização discipuladora, que ensina). Oração (ver doc MARCOS). Koinonia (trabalharia na frente pequenos grupos), Generosidade (também compaixão e graça). Faltando aqui a formação de líderes (dar um toque nisso).

%Preparar a terrar para o que vamos falar lá na frente. Senão lá vamos puxar algo novo que nunca foi falado.

\section{A primeira comunidade cristã entre os gentios}

%Princípios a trabalhar: ORAÇÃO, EVANGELIZAÇÃO DISCIPULADORA (INFLUENCIA O 1 CAPÍTULO), plantação de igrejas (mentalidade), formação de líderes, compaixão e graça (essa parte de contextualização vem aqui). 
