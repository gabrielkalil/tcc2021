...
\titlespacing{\subsection}{0pt}{21pt}{21pt}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\autor{Gabriel Kalil}
%\autor{Robson Valentin}
\instituicao{Faculdade Teológica Batista do Paraná}
%\titulo{Princípios da Igreja Multiplicadora} 
 \titulo{Princípios da Igreja Multiplicadora aplicados na vida de profissionais em movimento global para abertura de frentes evangelizadoras e/ou fortalecimento de igrejas} 
\data{2021} 
\local{Curitiba} 
\orientador{Prof. Me. Marcos Paulo Ferreira} 
\preambulo{Monografia apresentada ao curso de Teologia das Faculdades Batista do Paraná, como requisito parcial para obtenção do título de Bacharel em Teologia.\\\\Orientador: \imprimirorientador} 
...
%\renewcommand{\baselinestretch}{1.5} %[FABAPAR] espaçamento entre linhas
\setlength{\ABNTEXcitacaorecuo}{3cm} %[FABAPAR], 3cm (é como 4cm fabapar/word)


% \usepackage{fancyhdr}
% %HEADER AND PAGE NUMBER STYLES (explore fancyhdr)
% \pagestyle{fancy}
% \fancyhf{}
% \rhead{\thepage}
% \lhead{}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
%Consertando espaçamento do título
%\usepackage{titlesec}
...
Agradeço  Criador por tudo o que foi necessário para que esse trabalho, de valor pessoal para o autor, fosse possível: a vida, a Vida, a consciência, as complexas e ainda parcialmente compreendidas capacidades de cognição e linguagem, os dons e competências, a oportunidade de desenvolvê-los, enfim. Agradeço ao Criador por ter me dado identidade, sentido e propósito eternos. As palavras dos poetas gregos, referenciadas pelo apóstolo Paulo em seu sermão em Atenas, carregam uma profundidade semântica inalcançável, metafisica, incabível nas categorias do pensamento humano: "pois nele vivemos, nos movemos e existimos" (Atos 17:28). 

Cada dia vivido, cada experiência, cada nova lição aprendida, incrementam em mim um sentimento de profunda gratidão pelas obras do Criador, ao mesmo tempo que aumentam o peso da pergunta sem responsta definitiva: "como agradecer?". Resta somente expressar, dentro dos limites impostos por Ele mesmo, um simples "muito obrigado...", na esperança de que Ele veja, o que a consciência balbucia ao ler, e a linguagem sofre terrivelmente, e falta, ao tentar transcrever.

Agradeço a meus pais por transferirem suas vidas sobre a minha enquanto me apontavam o Caminho da Vida. Minha mãe, Geovanita Kalil, que à sua maneira, tantas vezes me protegeu de perigos que eu só vim a compreender na idade adulta. Meu pai, Antonio Kalil, o qual tantas vezes flagrei de mãos extendidas na porta do meu quarto, orando por mim. Agradeço a minha irmã, Raquel Lopes, minha parceira de adolescência, confidente, conselheira. As memórias são tantas, que fluiriam como um rio, que se transformaria em cachoeira ao encontrar os limites do parágrafo.

Minha gratidão a meus amados Rafaela, Sarah, Johanna, Benjamin e Esther, que juntamente comigo formam uma equipe missionária em movimento evangelizador, mundo adentro.

Agradeço ao amigo, pastor, companheiro no Caminho e orientador, Marcos Paulo Ferreira. Obrigado pelo seu exemplo de vida que me ensina, e inspira, a integrar intelecto e coração, ensino e serviço, fé e obras.

Agradeço a meu irmão e amigo Neander Brisola, pela amizade que venceu as diferenças, desavenças, teologias, distância física. Pelas muitas horas de conversa e cuidado, nas primaveras e invernos da vida.
...
\textual 
\chapter{Relatos bíblicos de adoração a Deus através da música}
A música sempre fez parte da vida humana e tem tido um papel importante no cotidiano das pessoas especialmente na forma como elas expressam suas emoções. Isso não é diferente quando o individuo inclina-se para adorar a Deus. Segundo Shedd (2007, p. 113) “a música estimula as emoções que, por sua vez, motivam a vontade e a confiança”, sugerindo que a música pode motivar o adorador e interferir no modo como ele se relaciona com Deus durante a adoração.

Tanto nos livros do Antigo Testamento como nos livros do Novo Testamento encontram-se inúmeros relatos, em diversificados locais e ocasiões na história da
humanidade, onde a música é utilizada como apoio ao momento de adoração. A música faz parte do cotidiano do ser humano e tem sido utilizada como instrumento
de várias formas religiosas. Busca-se aqui a contribuição que ela teve na história judaico-cristã, relatada pela Bíblia.

\section{O PAPEL DA MÚSICA NA CULTURA JUDAICO-CRISTÃ}
Os relatos bíblicos serão utilizados para compreensão do contexto cultural em
que eles aconteceram, neste caso especialmente a cultura dos hebreus dos tempos
bíblicos. Os historiadores descrevem os hebreus como um povo que gostava
imensamente de música, os relatos bíblicos confirmam isso.

Em seu livro “Manual dos tempos e costumes bíblicos”, Coleman (2017) busca
relatar como eram as principais características da cultura dos hebreus e o que
podemos afirmar sobre questões que era estruturais para aquele povo, e no caso da
música, um dos elementos estruturais, ele afirma:
\begin{citacao}A música se tornou um excelente meio de comunicação entre os seres
  humanos, e destes com Deus. Os hebreus expressavam suas mais
  profundas emoções em composições poéticas, que eram feitas para serem
  cantadas. A estrutura da poesia hebraica não era baseada em ritmo, mas em
  formas de raciocínio, em harmonia de ideias e em antíteses. Não seria errado
  afirmar que os antigos salmos eram sempre cantados, e geralmente com
  acompanhamento musical. (COLEMAN, 2017, p. 290)\end{citacao}
...
%adiciona numeracao página daqui pra baixo
% \pagestyle{fancy}
...
Nesse aspecto, o trabalho aqui apresentado, é de relevância pessoal para o autor, uma vez que descreve com bastante precisão sua própria experiência de vida. O autor trabalhou por diversos anos em empresas multi nacionais no Brasil, desenvolvendo o perfil de profissional em demanda global que o trabalho descreve. Ao mesmo tempo, cresceu no serviço ao Senhor, e envolvimento com a igreja local, entendendo, e vivendo em obediência, o chamado várias vezes referenciado neste trabalho, o chamado de Jesus relatado por Mateus (Mateus 28). Fazer discípulos, no movimento e dinâmica da vida, se tornou o estilo de vida do autor e sua família. No ano de 2016, juntamente com sua equipe ministerial (esposa e três filhos), o autor foi convidado pela empresa na qual trabalhava, para assumir um posto de trabalho de responsabilidade global na Suécia, como resultado do seu desenvolvimento profissional. Durante dois anos, o autor e sua família tiveram a oportunidade de se envolver com uma igreja local, e servir em diversos ministérios através da hospitalidade, ensino, cuidado, discipulado, entre outros, fortalecendo o trabalho nessa comunidade. A equipe do autor também desenvolveu outras atividades ministeriais, dentre as quais um pequeno grupo de homens que se reuiam semanalmente em um café na estacação de trem da cidade, para um momento de compartilhar e orar uns pelos outros. A esposa do autor iniciou, junto com outra discípula, um grupo de mulheres que cresceu, e continua a se reunir em casas da cidade de Gotemburgo. Como resultado desse trabalho, e a partir do exemplo do autor e sua equipe, outros discípulos foram encorajados a assumir mais responsabilidades no Reino, um deles recomeçando o grupo de homens, outro se envolvendo na liderança da igreja local. 

Os discipulado evangelizador aconteceu também fora da igreja. O autor desenvolveu relacionamentos significativos com colegas de trabalho de origem grega, yugoslava e brasileira, podendo ser uma testemunha. Esses relacionamentos se aprofundaram e persistem até o presente momento, embora o autor não mais resida na Suécia. Atualmente o autor e sua família residem na Alemanha, e nesse país, também desenvolveram relacionamentos de discipulado com diversas pessoas em várias cidades: alemães, turcos, italianos, africanos. Em atual processo de envolvimento com uma igreja local e na expectativa de trabalhar com refugiados em sua cidade, a caminhada do autor e sua equipe continua, com a firme conviccção de que o amor de Deus não vê limites de língua, cultura, e nem geo-política.

O trabalho conclui, portanto, mostrando que nos dias de hoje, discípulos comprometidos com Jesus Cristo, podem, intencionalmente, desenvolver competências profissionais que os habilitem a ser uma força evangelística de impacto global. Assim como os discípulos que iniciaram a igreja em Antioquia, discípulos leigos, através de suas competências profissionais podem levar o Evangelho até os confins da terra.
