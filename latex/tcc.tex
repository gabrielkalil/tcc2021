...
%TODO Precisamos rever o título para abarcar o sumário: "Igreja Multiplicadora aplicada a Discípulos Profissionais em movimento global "?
 \titulo{Princípios da Igreja Multiplicadora aplicados a Discípulos Profissionais em movimento global} 
\data{2021} 
\local{Curitiba} 
...
\renewcommand{\labelenumi}{\alph{enumi})} %[FABAPAR] Listas com letras
\begin{document} 
...
\tableofcontents*
\thispagestyle{empty} % imprime sumário
...
\subsection{O modelo de discipulado de Jesus} 
...
A partir da vinda do Espírito Santo narrada em Atos 2, se seguiu uma série de eventos que apontavam para um novo movimento entre discípulos. Esse movimento acontecia no desenrolar da normalidade dessa nova vida os discípulos tiveram muitas oportunidades para distribuir a graça de Deus (1 Pedro 4:10). Enquanto testemunhavam do que viam e ouviam (1 João 1:3), apresentavam a Jesus e o Reino de Deus. 

Uma atividade comum em seus dias era a ir ao templo para fazer orações, prática normal da vida de um judeu piedoso da época. Pedro e João, em um desses momentos narrado em Atos 3:1, se depararam com uma cena também comum para a época. Ao lado da porta do templo estava um aleijado, que era diariamente colocado ali para pedir esmolas, situação que certamente testemunharam muitas vezes. A partir desse evento de rotina, o novo impulso do Espírito Santo através de dois discípulos sensíveis, operou uma cura milagrosa e atraiu uma multidão, proporcionando a Pedro uma plataforma evangelística que em poucas palavras já apresentava Jesus como o messias esperado, sua natureza divina e ressurreição:
...
O próprio Jesus, na normalidade da vida de seus discípulos, abriu oportunidades para que as boas novas fossem proclamadas.
...
Aqui será exemplificada a parte lkjsflskdfj lkjlkj lkjlkjlj lkjlkj lkjljkestrutural e o exemplo dos resumos usados em Tese, Dissertação, Monografia e Trabalho Conclusão de Curso. Os resumos obedecerão às seguintes regras
